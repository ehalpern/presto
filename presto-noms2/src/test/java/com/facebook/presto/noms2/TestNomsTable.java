...
import static com.facebook.presto.noms2.MetadataUtil.TABLE_CODEC;
import static com.facebook.presto.spi.type.BigintType.BIGINT;
import static com.facebook.presto.spi.type.VarcharType.createUnboundedVarcharType;
import static org.testng.Assert.assertEquals;

public class TestNomsTable
{
    private final NomsTable exampleTable = new NomsTable("tableName",
            ImmutableList.of(new NomsColumn("a", createUnboundedVarcharType()), new NomsColumn("b", BIGINT)),
            ...
            throws Exception
    {
        ...
        NomsTable exampleTableCopy = TABLE_CODEC.fromJson(json);
