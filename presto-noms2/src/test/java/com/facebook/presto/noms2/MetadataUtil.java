...
public final class MetadataUtil
{
    ...
    public static final JsonCodec<Map<String, List<NomsTable>>> CATALOG_CODEC;
    public static final JsonCodec<NomsTable> TABLE_CODEC;
    public static final JsonCodec<NomsColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(NomsTable.class));
        TABLE_CODEC = codecFactory.jsonCodec(NomsTable.class);
        COLUMN_CODEC = codecFactory.jsonCodec(NomsColumnHandle.class);
    }
