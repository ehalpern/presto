...
public class NomsHttpServer
{
    private final LifeCycleManager lifeCycleManager;
    private final URI baseUri;

    public NomsHttpServer()
            throws Exception
    {
        Bootstrap app = new Bootstrap(
                new TestingNodeModule(),
                new TestingHttpServerModule(),
                new NomsHttpServerModule());
    ...
    private static class NomsHttpServerModule
            implements Module
    {
        @Override
        public void configure(Binder binder)
        {
            ...
            binder.bind(Servlet.class).annotatedWith(TheServlet.class).toInstance(new NomsHttpServlet());
        }
    }

    private static class NomsHttpServlet
            extends HttpServlet
    {
        @Override
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
                throws IOException
        {
            URL dataUrl = Resources.getResource(TestNomsClient.class, request.getPathInfo());
