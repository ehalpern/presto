...
public class TestNomsRecordSet
{
    private com.facebook.presto.noms.NomsHttpServer nomsHttpServer;
    private URI dataUri;
    ...
    public void testGetColumnTypes()
            throws Exception
    {
        RecordSet recordSet = new NomsRecordSet(new NomsSplit("test", "schema", "table", dataUri), ImmutableList.of(
        ...
        recordSet = new NomsRecordSet(new NomsSplit("test", "schema", "table", dataUri), ImmutableList.of(
                new NomsColumnHandle("test", "value", BIGINT, 1),
                new NomsColumnHandle("test", "text", createUnboundedVarcharType(), 0)));
    ...
    public void setUp()
            throws Exception
    {
        nomsHttpServer = new com.facebook.presto.noms.NomsHttpServer();
