...
public class NomsClusteringPredicatesExtractor
{
    private final List<NomsColumnHandle> clusteringColumns;
    private final ClusteringPushDownResult clusteringPushDownResult;
    private final TupleDomain<ColumnHandle> predicates;

    public NomsClusteringPredicatesExtractor(List<NomsColumnHandle> clusteringColumns, TupleDomain<ColumnHandle> predicates, VersionNumber cassandraVersion)
    {
    ...
    private static ClusteringPushDownResult getClusteringKeysSet(List<NomsColumnHandle> clusteringColumns, TupleDomain<ColumnHandle> predicates, VersionNumber cassandraVersion)
    {
        ...
        for (NomsColumnHandle columnHandle : clusteringColumns) {
