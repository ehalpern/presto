        ...
        implements RecordSink
{
    ...
    {
        this.nomsSession = requireNonNull(nomsSession, "nomsSession");
        ...
        this.insert = nomsSession.prepare(insert);
    ...
    public void finishRecord()
    {
        ...
        field = -1;
        nomsSession.execute(insert.bind(values.toArray()));
    }
