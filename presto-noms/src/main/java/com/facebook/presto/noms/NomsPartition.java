...
public class NomsPartition
{
    static final String UNPARTITIONED_ID = "<UNPARTITIONED>";
    public static final NomsPartition UNPARTITIONED = new NomsPartition();
    ...
    public NomsPartition(byte[] key, String partitionId, TupleDomain<ColumnHandle> tupleDomain, boolean indexedColumnPredicatePushdown)
    {
        this.key = key;
